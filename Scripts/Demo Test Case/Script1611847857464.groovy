...
WebUI.click(findTestObject('Object Repository/Page_Katalon Help Center/a_Sign in'))

WebUI.setText(findTestObject('Object Repository/Page_Sign in  Katalon Solution/input_Sign in to Katalon_user_email'), 'dungngo@katalon.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Sign in  Katalon Solution/input_Sign in to Katalon_user_pass'), 
    'eQTAPHAE7OyAm5RoDOgeVw==')
